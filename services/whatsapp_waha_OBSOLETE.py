...
class WhatsAppService:
    ...
    async def send_message(self, to: str, message: str) -> bool:
        ...
        """
        try:
            # Si WAHA no est� configurado, solo log
    ...
    async def send_typing(self, to: str) -> bool:
        ...
        try:
            ...
            # En WAHA real se podría usar sendChatState
    ...
    def format_response(self, result: Dict[str, Any]) -> str:
        ...
        try:
            ...
            return f"✅ {result.get('description', 'Mensaje procesado correctamente')}"
    
    def is_configured(self) -> bool:
        """
        Verifica si WAHA est� configurado
        """
